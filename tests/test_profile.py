...
class TestProfile(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.profile.total_votes, 109)

    def test_get_net_preference(self):
        self.assertEqual(self.profile.get_net_preference(1, 3), 29)
        self.assertEqual(self.profile.get_net_preference(1, 2), 109)
        self.assertEqual(self.profile.get_net_preference(0, 2), 75)
    ...
    def test_score(self):
        ...
        expected_score = [(0, 184), (1, 247), (2, 69), (3, 154)]
        self.assertEqual(self.profile.score(test_rule), expected_score)

    def test_ranking(self):
        test_rule = borda_rule
        expected_ranking = [(1, 247), (0, 184), (3, 154), (2, 69)]
